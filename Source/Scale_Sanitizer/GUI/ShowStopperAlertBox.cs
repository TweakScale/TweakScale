...
namespace TweakScale.GUI
{
	...
	{
		private static readonly string MSG = @"TweakScale found {0} **FATAL** issue(s) with your KSP install! This will probably corrupt your saves!
...
Your KSP.log lists every problematic part in your install; look for lines containing '[TweakScale] ERROR: **FATAL**'. Note that these parts are not the culprits, but innocent victims. No automated fix is possible for these problems.";
		...
		private static readonly string AMSG = @"close KSP, then ask for help with diagnosing the problem mod on the TweakScale forum thread. Please upload your KSP.log to a file share service and share a link to it in your post";
