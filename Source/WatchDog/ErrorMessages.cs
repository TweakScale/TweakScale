...
namespace TweakScale.WatchDog
{
	internal static class ErrorMessage
	{
		...
		public static readonly string ERR_TSREDIST_ALIEN = "999_Scale_Redist.dll <b>is not</b> what's TweakScale™ expects and it's not compatible. Please reinstall TweakScale™, replacing this file with the correct one.";
		public static readonly string ERR_TSREDIST_DEPRECATED = "999_Scale_Redist.dll found <b>is deprecated</b> and will not match TweakScale™ requirements. Please reinstall TweakScale™, replacing this file with the correct one.";
		...
		public static readonly string ERR_TS_ALIEN = "TweakScale/Scale.dll <b>is not</b> TweakScale™, but some other fork. Please reinstall TweakScale™, replacing this file with the correct one.";
