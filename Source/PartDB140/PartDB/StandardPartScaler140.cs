...
namespace TweakScale.PartDB
{
	public class StandardPartScaler : Scaler
	{
		...
		protected override void DoRestore()
		{
			...
			// Undoing https://github.com/TweakScale/TweakScale/issues/307 (the `absolute` should be true to KSP 1.4.3 - older ones don't use variant, but should behave similarly)
			this.ScalePart(true, true);
